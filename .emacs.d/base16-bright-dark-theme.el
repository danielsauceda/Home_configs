...
;;      (base03 "#b0b0b0")
  ...
  (custom-theme-set-faces 
   ...
   `(mode-line ((t (:foreground ,base04 :box nil))))
   ...
   `(region ((t (:background ,baseTEST))))  ;; region highlight
   ...
   `(font-lock-keyword-face ((t (:foreground ,base0E))))    ;; changes important words like class, if, not
...
(provide-theme 'base16-bright-dark)

;;; base16-bright-dark-theme.el ends here
